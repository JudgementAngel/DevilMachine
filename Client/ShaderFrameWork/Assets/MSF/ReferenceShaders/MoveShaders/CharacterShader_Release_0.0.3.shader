...
0.0.2
	Gamma矫正
*/
Shader "Move/CharacterShader/Release_0.0.3"
{
	Properties
	{
///Main
...
///Fragment Function			
	...
	///Initialize Some Variables
			...
			//Mask Variables
				...
				float silkValue = silkMask; //*(_oMin + ( (maskTex.r - _iMin) * (_oMax - _oMin) ) / (_iMax - _iMin)) ;
	...
	///Light
				...
				//lightIntensity = smoothstep(0, 1, saturate(lightIntensity));
	///LightWrapping
	...
	//			float3 lightWrapColor = LightWrapping_NdotL( albedoColor , _LightWrappingColor, _LightWrappingIntensity, roughness, normalDir,lightDir,viewDir, attenColor);
				...
				//lightWrapColor = smoothstep(0, 1, lightWrapColor);
	///FillLight
	...
	///Shadow
				...
				//shadowColor = smoothstep(0, 1, shadowColor);
	///EnvCol
	...
	///MatCap
				...
				matCapControl = smoothstep(0, 1, matCapControl);
	///FinCol
