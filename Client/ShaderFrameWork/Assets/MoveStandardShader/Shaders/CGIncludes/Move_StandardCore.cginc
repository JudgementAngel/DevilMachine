...
#ifndef MOVE_STANDARD_CORE_INCLUDED
#define MOVE_STANDARD_CORE_INCLUDED
...
half4 DebugForwardBase(half4 output,half4 i_tex)
{
        ...
        output.rgb = Albedo(i_tex);
    #elif defined(_DEBUG_NORMAL)
        #ifdef _NORMALMAP
            output.rgb = NormalInTangentSpace(i_tex)*0.5+0.5;
        #endif
    #endif
    
    return output;
}
half4 DebugForwardAdd(half4 output)
{
    #if defined(_DEBUG_ALBEDO)||defined(_DEBUG_NORMAL)
        output.rgb = 0.0f.xxx;
    #endif
    return output;
}
...
half4 fragForwardBaseInternal (VertexOutputForwardBase i)
{
    ...
    return DebugForwardBase(OutputForward (c, s.alpha),i.tex);
}
...
half4 fragForwardAddInternal (VertexOutputForwardAdd i)
{
    ...
    return DebugForwardAdd(OutputForward (c, s.alpha));
}
...
#endif // MOVE_STANDARD_CORE_INCLUDED
