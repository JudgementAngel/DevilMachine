...
#ifndef MOVE_STANDARD_CORE_FORWARD_SIMPLE_INCLUDED
#define MOVE_STANDARD_CORE_FORWARD_SIMPLE_INCLUDED

#include "Move_StandardCore.cginc"
...
half4 fragForwardBaseSimpleInternal (VertexOutputBaseSimple i)
{
    ...
    return DebugForwardBase( OutputForward (half4(c, 1), s.alpha),i.tex);
}
...
half4 fragForwardAddSimpleInternal (VertexOutputForwardAddSimple i)
{
    ...
    return DebugForwardAdd(OutputForward (half4(c, 1), s.alpha));
}
