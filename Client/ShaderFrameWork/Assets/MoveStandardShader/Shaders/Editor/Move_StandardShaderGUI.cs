...
{
    internal class Move_StandardShaderGUI : ShaderGUI
    {
        ...
        private static class Styles
        {
            ...
            public static readonly string[] debugNames = Enum.GetNames(typeof(DebugMode));
        }
        ...
        public void FindProperties(MaterialProperty[] props)
        {
            ...
            debugMode = FindProperty("_Debug", props);
        ...
        void CullModePopup(Material material)
        {
            ...
            var mode = (CullMode)cull.floatValue;
            ...
            if (EditorGUI.EndChangeCheck())
            {
                ...
                cull.floatValue = (float)mode;
                material.SetFloat("_Cull", cull.floatValue);
            }
        ...
        void DebugModePopup()
        {
            EditorGUI.showMixedValue = debugMode.hasMixedValue;
            var mode = (DebugMode)debugMode.floatValue;

            EditorGUI.BeginChangeCheck();
            mode = (DebugMode)EditorGUILayout.Popup(Styles.debugMode, (int)mode, Styles.debugNames);
            if (EditorGUI.EndChangeCheck())
            {
        ...
        void DoNormalArea()
        {
            ...
            if (bumpScale.floatValue != 1 && UnityEditorInternal.InternalEditorUtility.IsMobilePlatform(EditorUserBuildSettings.activeBuildTarget))
                if (m_MaterialEditor.HelpBoxWithButton(
                        EditorGUIUtility.IconContent("Bump scale is not supported on mobile platforms"),
                        EditorGUIUtility.IconContent("Fix Now")))
                {
        ...
        void DoAlbedoArea(Material material)
        {
            ...
            if (((BlendMode)material.GetFloat("_Mode") == BlendMode.Cutout || (BlendMode)material.GetFloat("_Mode") == BlendMode.FadeZWriteCutout))
            {
        ...
        public static void SetupMaterialWithBlendMode(Material material, BlendMode blendMode)
        {
            switch (blendMode)
            {
                ...
                case BlendMode.Transparent:
                    ...
                    material.renderQueue = (int)UnityEngine.Rendering.RenderQueue.Transparent;
                    break;
                case BlendMode.FadeZWriteCutout:
                    material.SetOverrideTag("RenderType", "Transparent");
                    material.SetInt("_SrcBlend", (int)UnityEngine.Rendering.BlendMode.SrcAlpha);
                    material.SetInt("_DstBlend", (int)UnityEngine.Rendering.BlendMode.OneMinusSrcAlpha);
                    material.SetInt("_ZWrite", 1);
        ...
        public static void SetupMaterialWithDebugMode(Material material,DebugMode debugMode)
        {
            switch(debugMode)
            {
                case DebugMode.None:
                    material.DisableKeyword("_DEBUG_ALBEDO");
                    material.DisableKeyword("_DEBUG_NORMAL");
                    break;
                case DebugMode.Albedo:
                    material.EnableKeyword("_DEBUG_ALBEDO");
                    material.DisableKeyword("_DEBUG_NORMAL");
                    break;
                case DebugMode.Normal:
                    material.DisableKeyword("_DEBUG_ALBEDO");
                    material.EnableKeyword("_DEBUG_NORMAL");
                    break;
            }
        }
        ...
        {
            SetupMaterialWithBlendMode(material, (BlendMode)material.GetFloat("_Mode"));
            SetupMaterialWithDebugMode(material, (DebugMode)material.GetFloat("_Debug"));
