...
Shader "Move_Standard (Roughness setup)"
{
    Properties
    {
        ...
        [HideInInspector] _Debug ("__debug", Float) = 0.0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "CGIncludes/Move_StandardCoreForward.cginc"
        ...
        Pass
        {
            ...
            #include "CGIncludes/Move_StandardCore.cginc"
    ...
    FallBack "VertexLit"
    CustomEditor "Move_StandardRoughnessShaderGUI"
}
