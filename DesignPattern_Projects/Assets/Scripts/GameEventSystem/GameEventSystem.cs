...
public class GameEventSystem : IGameSystem
{
    ...
    {
        if(mGameEvents.ContainsKey(GameEventType.EnemyKilled) == false)
            mGameEvents.Add(GameEventType.EnemyKilled, new EnemyKilledSubject());
        if (mGameEvents.ContainsKey(GameEventType.SoldierKilled) == false)
            mGameEvents.Add(GameEventType.SoldierKilled, new SoldierKilledSubject());
        if (mGameEvents.ContainsKey(GameEventType.NewStage) == false)
